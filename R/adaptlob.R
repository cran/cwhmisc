...
#   Walter Gander, 08/03/98
  ...
  if ((is + (i1-i2) == is) | (m <= a) | (b <= m)) {
    ...
    Q1 <- adaptsimstp (f,term, a,m,fa,fml,fm,is,trace,...)
    Q2 <- adaptsimstp (f,term, m,b,fm,fmr,fb,is,trace,...)
...
#   Walter Gautschi, 08/03/98
  ...
  if ((is + (i1-i2) == is) | (m <= a) | (b <= m)) {
    ...
    Q1 <- adaptlobstp(f,term, a,mll,fa,fmll,is,trace,...)
    Q2 <- adaptlobstp(f,term, mll,ml,fmll,fml,is,trace,...)
    Q3 <- adaptlobstp(f,term, ml,m,fml,fm,is,trace,...)
    Q4 <- adaptlobstp(f,term, m,mr,fm,fmr,is,trace,...)
    Q5 <- adaptlobstp(f,term, mr,mrr,fmr,fmrr,is,trace,...)
    Q6 <- adaptlobstp(f,term, mrr,b,fmrr,fb,is,trace,...)
