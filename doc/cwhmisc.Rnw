%% cwhmisc.Rnw   2008-11-19, 10:56,   CWHoffmann
...
\title{\textbf{The package "cwhmisc", a short overview}}
\author{Christian W. Hoffmann\\Swiss Federal Research Institute WSL}
\maketitle
...
mult.fig.p           &  Plot Setup for MULTiple FIGures, incl. Main Title \\
...
\begin{Stable}{|p{35mm}p{115mm}|}{Functions for statistical use, data manipulation}{t:stat}
\hline
